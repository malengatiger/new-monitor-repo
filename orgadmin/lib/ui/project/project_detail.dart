        ...
        bottom: PreferredSize(
          ...
          child: Column(
            children: <Widget>[
              ...
              SizedBox(height: 20,),
              Text('${project.description}', style: Styles.whiteMedium,
          ...
          isBusy? Container() : Padding(
            ...
            child: ListView(
              children: <Widget>[
                  ...
                  child: Card(
                    ...
                    child: Center(
                      child: Column(
                        children: <Widget>[
                          SizedBox(height: 8,),
                          Text('${getFormattedNumber(0, context)}',
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(context, SlideRightRoute(
                            widget: PhotoGallery(project: project,),
                          ));
                        },
                        child: Card(
                          elevation: 4,
                          child: Center(
                            child: Column(
                              children: <Widget>[
                                SizedBox(height: 8,),
                                Text('${getFormattedNumber(project.photoUrls.length, context)}',
                      ...
                      child: Card(
                        ...
                        child: Center(
                          child: Column(
                            children: <Widget>[
                              SizedBox(height: 8,),
                              Text('${getFormattedNumber(project.videoUrls.length, context)}',
                ...
                SizedBox(height: 24,),
                Row(
                  mainAxisAlignment: project.settlements.isEmpty?  MainAxisAlignment.center : MainAxisAlignment.spaceEvenly,
                  children: <Widget>[
                    Container(
                      height: 100, width: 140,
                      child: Card(
                        ...
                        child: Center(
                          child: Column(
                            children: <Widget>[
                              SizedBox(height: 8,),
                              Text('${getFormattedNumber(project.ratings.length, context)}',
                    ...
                    project.settlements.isEmpty? Container() : Container(
                      height: 100, width: 140,
                      child: Card(
                        elevation: 4,
                        child: Center(
                          child: Column(
                            children: <Widget>[
                              SizedBox(height: 8,),
                              Text('${getFormattedNumber(project.settlements.length, context)}',
  ...
  void _navTapped(int value) {
    ...
    switch(value) {
      case 0:
        ...
        Navigator.push(context, SlideRightRoute(
          widget: ProjectEditor(project: widget.project,),
        ));
        break;
      case 1:
