...
class SettlementExpressRoutes {
    routes(app) {
        ...
        app.route("/addSettlement").post((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield settlement_helper_1.SettlementHelper.addSettlement(req.body.settlementName, req.body.email, req.body.cellphone, req.body.countryID, req.body.countryName, parseFloat(req.body.latitude), parseFloat(req.body.longitude), parseInt(req.body.population));
